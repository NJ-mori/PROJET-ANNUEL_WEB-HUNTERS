...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['image'])) {
    ...
    if (!in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'gif']) || !in_array($mimeType, ['image/jpeg', 'image/png', 'image/gif'])) {
    ...
    $stmt = $pdo->prepare("INSERT INTO captcha_images (filename, image_data, mime_type, active, created_at) VALUES (?, ?, ?, 1, NOW())");
